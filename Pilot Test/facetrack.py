...
class Scheduler:
    ...
    def add_schedule(self, admin_panel, entry_last_name, entry_first_name, entry_schedule_date, entry_start_time, entry_end_time):
        ...
        # Fetch user ID based on last name and first name
        conn = sqlite3.connect('user_data.db')
        c = conn.cursor()
    ...
    def view_schedules(self):
        # Implement viewing schedules logic here
        pass
    ...
    def create_main_window(self):
        ...
        # Create and place the login, register, and admin buttons
    ...
    def register(self):
        # Implementation of registration window
        pass
    ...
    def admin_login(self, admin_login_window, entry_admin_username, entry_admin_password):
        ...
        if admin_username == 'admin' and admin_password == 'password':  # Replace with actual admin credentials check
